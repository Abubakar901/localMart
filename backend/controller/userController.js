...
// update User Profile
exports.updateProfile = catachAsyncError (async (req, res, next) => {
...
// update role - admin
exports.UpdateRole = catachAsyncError( async (req, res, next ) => {
    const newUserData = {
        name : req.body.name,
        email: req.body.email,
        role: req.body.role
...
// delete role - admin
exports.deleteUser = catachAsyncError( async (req, res, next ) => {
